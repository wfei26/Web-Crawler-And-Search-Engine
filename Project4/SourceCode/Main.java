...
public class Main {
    public static void main(String[] args) {
        ...
        String dirPath = "/Users/hongbowang/Downloads/latimes";
        File dir = new File(dirPath
        Set<String> edges = new HashSet<>();
        File result = new File("/Users/hongbowang/Downloads/EdgeList/src/result.txt");
        File mapFile = new File("/Users/hongbowang/Downloads/URLtoHTML_latimes.csv");
        try {
